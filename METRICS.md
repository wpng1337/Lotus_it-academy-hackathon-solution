...
## Эксперимент: v6 — sparse fix + variants + RERANK=25
- **Дата:** 2026-04-18T18:22:00Z
- **Git tag:** `v6-multi`
- **Изменения:**
  - **FIX:** Sparse query: search_text + keywords комбинируются (раньше search_text перезаписывал keywords)
  - question.variants для мультизапроса dense (до 2 альтернативных формулировок)
  - RERANK_LIMIT: 20→25

> **Ожидания:** Sparse fix даст больше recall. Variants расширят semantic search. RERANK=25 улучшит NDCG.
...
| Версия | Score | Recall | NDCG | RERANK | CHUNK | Комментарий |
|---|---|---|---|---|---|---|
| v3-fix | 0.5339 | 0.5535 | 0.4556 | 15 | 256 | Baseline наш |
| v4 | 0.5083 | 0.5252 | 0.4406 | 10 | 256 | ❌ слишком агрессивно |
| **v5** | **0.5517** | **0.5751** | **0.4578** | 20 | 384 | ✅ лучший |
| v6 | ? | ? | ? | 25 | 384 | ⏳ ожидание |
| 🥇 Лидер | **0.604** | ? | ? | ? | ? | Цель |
